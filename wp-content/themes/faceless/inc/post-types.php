...
function tools_post_type() {
	...
	$args = array(
		'label'                 => __( 'Tools', 'text_domain' ),
		'description'           => __( 'Seo Tools', 'text_domain' ),
		'labels'                => $labels,
