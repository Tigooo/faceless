    ...
    <main class="relative overflow-hidden">
                ...
                <div class="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
                    <div style="opacity: 1; transform: none;">
                        ...
                        <h1 class="text-4xl sm:text-5xl lg:text-6xl font-display font-bold leading-[1.1] mb-6">
                            <?php echo $hero_title_back ? $hero_title_back : '';?> <span class="text-gradient"><?php echo $hero_title_colored ? $hero_title_colored : '';?></span>
                        </h1>
                        <?php endif;?>
                        <?php if($hero_text):?>
                    ...
                    <div class="relative" style="opacity: 1; transform: none;">
                        <div class="relative aspect-square max-w-lg mx-auto">
                            ...
                            <div class="absolute inset-8 rounded-full bg-gradient-to-br from-primary/10 via-secondary/5 to-accent/10 flex items-center justify-center">
                                ...
                                <div class="absolute animate-float-6 -top-4 -right-4 bg-card border border-border rounded-2xl px-5 py-4 shadow-lg"
                                    ...
                                    <div class="text-2xl font-display font-bold text-gradient"><?php echo $animated_circle_item_title_1;?></div>
                                    <div class="text-xs text-muted-foreground"><?php echo $animated_circle_item_text_1;?></div>
                                </div>
                                <?php endif;?>
                                <?php if($animated_circle_item_title_2 and $animated_circle_item_text_2):?>
                                <div class="absolute animate-float-5 -bottom-4 -left-4 bg-card border border-border rounded-2xl px-5 py-4 shadow-lg" style="transform: translateY(4.35733px);">
                                    <div class="text-2xl font-display font-bold text-gradient"><?php echo $animated_circle_item_title_2;?></div>
                                    <div class="text-xs text-muted-foreground"><?php echo $animated_circle_item_text_2;?></div>
                                </div>
                                <?php endif;?>
                                <?php if($animated_circle_item_title_3 and $animated_circle_item_text_3):?>
                                <div class="absolute animate-float-5 top-1/2 -right-8 bg-card border border-border rounded-2xl px-5 py-4 shadow-lg" style="transform: translateY(-1.3067px);">
                                    <div class="text-2xl font-display font-bold text-gradient"><?php echo $animated_circle_item_title_3;?></div>
                                    <div class="text-xs text-muted-foreground"><?php echo $animated_circle_item_text_3;?></div>
                                </div>
                                <?php endif;?>
                                <div class="relative w-full h-full flex items-center justify-center">
                                    ...
                                    <div class="animate-float-7 relative flex flex-col items-center" >
                                        <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-gradient-main flex items-center justify-center shadow-2xl">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"
                                                class="lucide lucide-megaphone w-10 h-10 sm:w-12 sm:h-12 text-primary-foreground">
        ...
        <section class="py-16 px-4 border-y border-border/30">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="flex flex-wrap items-center justify-center gap-10 md:gap-16">
                    ...
                    <span class="text-2xl md:text-3xl font-display font-bold text-muted-foreground/25 hover:text-muted-foreground/50 transition-colors duration-300"
        ...
        <section class="py-28 px-4 relative overflow-hidden">
            <div class="absolute inset-0 pointer-events-none">
                <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 rounded-full blur-3xl"></div>
            </div>
            <div class="max-w-6xl mx-auto relative">
                <div class="text-center mb-16" style="opacity: 1; transform: none;">
                    ...
                    <h2 class="text-3xl sm:text-4xl md:text-5xl font-display font-bold leading-snug">
                        <?php echo $partnerships_title_black;?> <span class="text-gradient"><?php echo $partnerships_title_colored;?></span>
                    </h2>
                    <?php endif;?>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="group relative" style="opacity: 1; transform: none;">
                        <div class="absolute -inset-0.5 bg-gradient-to-br from-primary to-secondary rounded-3xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500"> </div>
                        <div class="relative bg-card border border-border/50 rounded-3xl p-8 h-full hover:border-primary/20 transition-all duration-300">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center mb-12" style="opacity: 1; transform: none;">
                    <h2 class="text-3xl sm:text-4xl font-display font-bold">
                        <?php echo $brands_title_black;?> <span class="text-gradient"><?php echo $brands_title_colored;?></span>
                    </h2>
                </div>
                <?php endif;?>
                <div class="grid sm:grid-cols-2 gap-8">
                    ...
                    <div class="flex gap-4" style="opacity: 1; transform: none;">
                        ...
                        <div class="brang__icon flex-shrink-0 w-12 h-12 rounded-2xl bg-gradient-to-br from-primary/10 to-secondary/10 flex items-center justify-center">
        ...
        <section class="py-28 px-4">
            <div class="max-w-xl mx-auto text-center" style="opacity: 1; transform: none;">
                <?php if($cta_icon):?>
                <div class="cta__icon inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-main mb-6">
                    <?php echo $cta_icon;?>
                </div>
                <?php endif;?>
                <?php if($cta_title):?>
                ...
                <?php if($cta_btn_text and $cta_btn_link):?>
                <a class="inline-flex items-center justify-center gap-2 whitespace-nowrap font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow-gradient hover:shadow-gradient-lg hover:scale-[1.03] h-12 bg-gradient-main hover:opacity-90 text-primary-foreground rounded-full px-10 py-6 text-lg"
                    href="<?php echo  $cta_btn_link;?>">
